...
const airportTerminals = {
    terminal1: {
        name: {
            ko: '인천국제공항 제1터미널',
            en: 'Incheon International Airport Terminal 1',
            ja: '仁川国際空港第1ターミナル',
            zh: '仁川国际机场第1航站楼',
            es: 'Aeropuerto Internacional de Incheon Terminal 1'
        },
        lat: 37.447660711,
        lng: 126.452329312,
        code: 'ICN_T1',
    ...
    terminal2: {
        name: {
            ko: '인천국제공항 제2터미널',
            en: 'Incheon International Airport Terminal 2',
            ja: '仁川国際空港第2ターミナル',
            zh: '仁川国际机场第2航站楼',
            es: 'Aeropuerto Internacional de Incheon Terminal 2'
        },
        lat: 37.468741034,
        lng: 126.433512468,
        code: 'ICN_T2',
